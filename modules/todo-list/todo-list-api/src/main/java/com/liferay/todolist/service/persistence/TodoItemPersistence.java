...
public interface TodoItemPersistence extends BasePersistence<TodoItem> {
	 ...
	 * @return the matching todo items
	 */
	public java.util.List<TodoItem> findByTitle(String title);
	 ...
	 * @return the range of matching todo items
	 */
	public java.util.List<TodoItem> findByTitle(
	 ...
	 */
	public java.util.List<TodoItem> filterFindByGroupId(long groupId);
	 ...
	 */
	public java.util.List<TodoItem> filterFindByGroupId(
		long groupId, int start, int end);
