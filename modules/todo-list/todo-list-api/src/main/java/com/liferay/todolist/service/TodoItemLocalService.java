...
public interface TodoItemLocalService
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TodoItem> getTodoItemsByGroupId(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TodoItem> getTodoItemsByTitle(String title, int start, int end);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TodoItem> getTodoItemsByTitle(
	...
	public TodoItem unDoneTodoItem(
			long todoItemId, ServiceContext serviceContext)
		throws PortalException;
