 ...
 */
@Generated("")
@GraphQLName("TodoItemRequest")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "TodoItemRequest")
public class TodoItemRequest implements Serializable {

	public static TodoItemRequest toDTO(String json) {
		return ObjectMapperUtil.readValue(TodoItemRequest.class, json);
	}
	...
	@Schema(
		defaultValue = "com.liferay.todolist.resetbuild.dto.v1_0.TodoItemRequest",
		name = "x-class-name"
	)
