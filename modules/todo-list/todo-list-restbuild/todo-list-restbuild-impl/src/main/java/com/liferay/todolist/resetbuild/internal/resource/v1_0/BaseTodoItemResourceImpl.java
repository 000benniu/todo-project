...
@Generated("")
@Path("/v1.0")
public abstract class BaseTodoItemResourceImpl
	implements TodoItemResource, EntityModelResource,
			   VulcanBatchEngineTaskItemDelegate<TodoItem> {
	...
	public void create(
			java.util.Collection<TodoItem> todoItems,
