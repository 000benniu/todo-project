package com.liferay.todolist.web.display.context;
...
public class TodoItemsManagementToolbarDisplayContext extends BaseManagementToolbarDisplayContext {
	
	public TodoItemsManagementToolbarDisplayContext(
		...
		return new CreationMenu() {
			{
				addDropdownItem(
					dropdownItem -> {
						...
						dropdownItem.setLabel(LanguageUtil.get(request, "add-todoItem"));
					});
			}
		};
	}
	...
	/**
	 * Returns the todoItem list display style.
	 * 
	...
	public String getSearchActionURL() {
		...
		searchURL.setProperty("mvcRenderCommandName", MVCCommandNames.VIEW_TODOITEMS);
	...
	public List<ViewTypeItem> getViewTypeItems() {
		...
		portletURL.setParameter("mvcRenderCommandName", MVCCommandNames.VIEW_TODOITEMS);
	...
	private PortletURL _getCurrentSortingURL() throws PortletException {
		...
		sortingURL.setParameter("mvcRenderCommandName", MVCCommandNames.VIEW_TODOITEMS);
