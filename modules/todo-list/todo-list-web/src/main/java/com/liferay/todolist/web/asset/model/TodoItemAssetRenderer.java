...
/**
 * Asset renderer for todoItems.
 *
 * @author liferay
 */
public class TodoItemAssetRenderer extends BaseJSPAssetRenderer<TodoItem> {

	public TodoItemAssetRenderer(TodoItem todoItem) {

		_todoItem = todoItem;
	}

	@Override
	public TodoItem getAssetObject() {
		return _todoItem;
	}
	...
	public String getSummary(PortletRequest portletRequest,
		...
		String summary = HtmlUtil
				.stripHtml(StringUtil.shorten(_todoItem.getDescription(themeDisplay.getLocale()), abstractLength));
	...
	public PortletURL getURLEdit(LiferayPortletRequest liferayPortletRequest,
		...
		Group group = GroupLocalServiceUtil.fetchGroup(_todoItem.getGroupId());
		...
		portletURL.setParameter("todoItemId", String.valueOf(_todoItem.getTodoItemId()));
	...
	public String getURLViewInContext(LiferayPortletRequest liferayPortletRequest,
		...
		try {
			long plid = PortalUtil.getPlidFromPortletId(_todoItem.getGroupId(),
			...
			if (plid == LayoutConstants.DEFAULT_PLID) {
				...
				portletURL = PortletURLFactoryUtil.getPortletURLFactory().create(liferayPortletRequest,
						TodoListWebPortletKeys.TODOLISTWEB_PORTLETNAME, plid, PortletRequest.RENDER_PHASE);
			}

			portletURL.setParameter("mvcRenderCommandName", MVCCommandNames.VIEW_TODOITEM);
			portletURL.setParameter("todoItemId", String.valueOf(_todoItem.getTodoItemId()));
	...
	public String getUuid() {
		return _todoItem.getUuid();
	}

	@Override
	public boolean hasEditPermission(PermissionChecker permissionChecker) throws PortalException {

		return TodoItemPermission.contains(permissionChecker, _todoItem, ActionKeys.UPDATE);
	}

	@Override
	public boolean hasViewPermission(PermissionChecker permissionChecker) throws PortalException {

		return TodoItemPermission.contains(permissionChecker, _todoItem, ActionKeys.VIEW);
	}
	...
	public boolean include(HttpServletRequest request,
		...
		request.setAttribute("todoItem", _todoItem);
