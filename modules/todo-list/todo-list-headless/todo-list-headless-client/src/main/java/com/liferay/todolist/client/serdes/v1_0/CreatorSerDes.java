package com.liferay.todolist.client.serdes.v1_0;

import com.liferay.todolist.client.dto.v1_0.Creator;
import com.liferay.todolist.client.json.BaseJSONParser;
...
public class CreatorSerDes {
	...
	public static String toJSON(Creator creator) {
		...
		if (creator.getCreator() != null) {
			...
			sb.append(String.valueOf(creator.getCreator()));
		}
	...
	public static Map<String, String> toMap(Creator creator) {
		...
		if (creator.getCreator() == null) {
			...
			map.put("creator", String.valueOf(creator.getCreator()));
		}
