package com.liferay.todolist.resource.v1_0.test;
...
import com.liferay.todolist.client.dto.v1_0.TodoItemModel;
import com.liferay.todolist.client.http.HttpInvoker;
import com.liferay.todolist.client.pagination.Page;
import com.liferay.todolist.client.pagination.Pagination;
import com.liferay.todolist.client.resource.v1_0.TodoItemModelResource;
import com.liferay.todolist.client.serdes.v1_0.TodoItemModelSerDes;
...
public abstract class BaseTodoItemModelResourceTestCase {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (Field field :
				ReflectionUtil.getDeclaredFields(
					com.liferay.todolist.dto.v1_0.TodoItemModel.class)) {
	...
	@Inject
	private com.liferay.todolist.resource.v1_0.TodoItemModelResource
